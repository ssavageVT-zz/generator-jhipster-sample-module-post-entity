...
module.exports = class extends BaseGenerator {
    get initializing() {
        return {
            ...
            displayLogo() {
                ...
                this.log(`\nWelcome to the ${chalk.bold.yellow('JHipster sample')} generator! ${chalk.yellow(`v${packagejs.version}\n`)}`);
            },
            checkJhipster() {
    ...
    writing() {
        ...
        try {
            this.registerModule('generator-jhipster-sample', 'entity', 'post', 'entity', 'Sample Module Post Entity');
        } catch (err) {
    ...
    install() {
        ...
        this.log('End of sample generator');
    }
};
